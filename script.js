...
function toggleExpectation(index) {
    ...
    const descriptions = [
        "Уникальная коллекция из 32 оригинальных картин Фёдора Конюхова, созданных во время его экспедиций. Каждое полотно рассказывает историю встречи с океаном, штормами и бескрайними просторами. Особое внимание привлекают картины, написанные в открытом море.",
